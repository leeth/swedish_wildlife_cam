...
def report(input_path: str, output_path: str, format: str,
    ...
    # Load data
    if input_path.endswith('.parquet'):
        engine.load_observations_from_parquet(input_path)
    else:
        click.echo("Directory input not yet implemented")
        return
