...
from .logging_config import get_infrastructure_logger, get_logger
...
def main():
    ...
    infrastructure_logger = get_infrastructure_logger()

    logger.info("Starting Odin CLI")
    infrastructure_logger.info("Odin CLI initialized")
...
def handle_infrastructure_command(infra_manager: InfrastructureManager, command: str, verbose: bool):
    ...
    if command == "setup":
        ...
        logger.info("Infrastructure scaled up")
        ...
        logger.info("Infrastructure scaled down")
        print("✅ Infrastructure scaled down!")
    else:
        logger.error(f"Unknown infrastructure command: {command}")
...
def handle_pipeline_command(pipeline_manager: PipelineManager, command: str, verbose: bool):
    ...
    if command == "run":
        ...
        logger.error(f"Unknown pipeline command: {command}")
