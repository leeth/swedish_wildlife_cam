...
class RedisQueueAdapter(QueueAdapter):
    ...
    def __init__(self, host: str = "localhost", port: int = 6379, db: int = 0):
        try:
            ...
            raise ImportError("redis package required for RedisQueueAdapter") from e
...
class SQSAdapter(QueueAdapter):
    ...
    def __init__(self, region: str = "eu-north-1"):
        try:
            ...
            raise ImportError("boto3 package required for SQSAdapter") from e
        self.region = region
...
class PubSubAdapter(QueueAdapter):
    ...
    def __init__(self, project_id: str):
        try:
            ...
            raise ImportError("google-cloud-pubsub package required for PubSubAdapter") from e
