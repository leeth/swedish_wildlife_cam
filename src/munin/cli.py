...
from .data_ingestion import OptimizedExifExtractor, OptimizedFileWalker
...
def stage2(manifest_path: str, output_path: str, model: str,
    ...
    YOLOClassifier(model, confidence)
